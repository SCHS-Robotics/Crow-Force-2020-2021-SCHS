...
public class opencvSkystoneDetector_v2 extends SubSystem {
    ...
    //BILL NYE
    //private static int val1 = -1, val2 = -1, val3 = -1, val4 = -1, bitset = 0;  // greater number the higher the pos
    private static int valMid = -1, valUp = -1, valDown = -1, bitset = 0;
    //public static intskystornInd = 0;
    public static int skystoneInd = 0;
    //private static double rectHeight = 1.5 / 8.0, rectWidth = 0.6 / 8.0;
    private static double rectHeight = 1.5 / 8.0, rectWidth = 0.6 / 8.0;

    //private static double offsetX = -0.5 / 8.0;
    private static double offsetX = -0.5 / 8.0; //changing this moves the three rects and the three circles left or right, range : (-2, 2) not inclusive
    ...
    /*
    private static double[][] pos = new double[4][2];
    pos[0][0] = 4.0 / 8.0 + offsetX;
    pos[0][1] = 4.5 / 8.0 + offsetY;
        pos[1][0] = 4.0 / 8.0 + offsetX;
    pos[1][1] = 3.0 / 8.0 + offsetY;
    pos[2][0] = 4.0 / 8.0 + offsetX;
    pos[2][1] = 1.5 / 8.0 + offsetY};
    pos[3][0] = 4.0 / 8.0 + offsetY;
    pos[3][1] = 0.0 / 8.0 + offsetY;
    */
    ...
    public String check() {
        ...
        String[] res = { "Bottom", "Lower Middle", "Upper Middle", "Top" };
